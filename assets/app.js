...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var isDeepDive = /Reference ·/.test(crumb.textContent);
    if (m || isDeepDive) {
      var current = m ? parseInt(m[1], 10) : 0;
      var pages = ["01-core-stack.html", "02-build-ship.html", "03-data-ds.html",
                   "04-ai-agents.html", "05-ai-domains.html", "06-content-viz-comm.html",
                   "07-lead-ops-edge.html", "08-build-your-own-skill.html"];
      ...
      dd.href = "00-matrix.html";
      dd.className = "dd-chip" + (isDeepDive ? " here" : "");
      dd.textContent = "17×10 matrix";
